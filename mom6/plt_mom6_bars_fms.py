...
# Open MPI runtimes
with open('mom6_fms_timings.yaml', 'r') as timings_file:
...
ax.set_title('Relative MOM6 component runtimes')
...
plt.savefig('mom6_bars_fms.svg', facecolor='none', bbox_inches='tight')
plt.close()
